...
\years{2012} 
% \textit{Does it Ever Get Dark Here}, Jazz Quintet \\
% \textit{the window that was also a door}, Jazz Quintet \\
% \textit{Iterations of an elephant tree}, Jazz Quintet\\
% \textit{Happy Harvey}, Jazz Quintet\\
% \textit{Minority of One}, Jazz Quintet\\
% \textit{Love in the ruins}, Jazz Quintet\\
% \textit{We believe in inertia}, Jazz Quintet\\
% \textit{Sharp Accent}, Carbon Trio (Jazz Trio) \\
% \textit{Bell Effect}, Carbon Trio (Jazz Trio) \\
% \textit{They talk but their words don't register}, Carbon Trio (Jazz Trio)\\
% \textit{Three,two, and sometimes one}, Carbon Trio (Jazz Trio)\\
...
Music Appreciation \\
\years{2023} Special Topics: History of Recorded Music \\
\years{2022} Special Topics: Programming for Sound Design \\ 
\years{2021} Special Topics: Sound Forensics 

% \pagebreak

\subsection*{Louisiana State University, Baton Rouge, LA}
\years{2018--20} CSC 2463 -- Programming Digital Media, Instructor \\
\years{2020} MUS 4744 – Mobile Music, Teaching Assistant 

\subsection*{Liberty Magnet High School (Formerly known as Lee Magnet High School), Baton Rouge, LA}
\years{2019--20} Coding for the Web \\
\years{2018, 2020} Introduction to Computational Thinking \\ 
\years{2018} CSC 2463 – Programming Digital Media


\subsection*{Other}
\years{2020} Futures Fund, Online Content Creator, Coding for the Web, Baton Rouge, LA\\
...
\years{2011} Instructor, Jazz Combo, University of New Orleans, LA
