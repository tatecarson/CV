...
% TODO: add more areas on interest based on research.
...
\years{2023} \textbf{``Resonant Landscapes: DSU Researchers Make Music with Nature''} \\
Dakota State University News, December 13, 2023 \\
\textit{Written by Mary Askren} \\
...
\years{2024} \textbf{Program Visibility and Recruitment} \\
Collaborated with DSU's marketing department to update the Sound Design webpage and participated in campus visits for prospective students, promoting recruitment for the Digital Arts and Design program.\\
\years{2024} \textbf{Collaboration with Lake County Museum} \\
Developed a Digital Sound Design internship with the Lake County Museum, focusing on creating a podcast based on museum exhibitions and collections.\\
\years{2023--24} \textbf{Reviewer, NIME Conference} \\
Served as a reviewer for the New Interfaces for Musical Expression (NIME) conference, contributing to the peer review process for professional conferences in the field of digital sound design.
\years{2022--Present} \textbf{Internship Coordinator, Digital Arts and Design Program} \\
Served as the Internship Coordinator, connecting students with relevant, career-focused opportunities. \\
\years{2022--Present} \textbf{Faculty Advisor, DSU Live Student Club} \\
Advised the student club DSU Live, managed paperwork for student compensation, and reported on General Activity Fee (GAF) spending to the GAF Committee.\\
\years{2022--Present} \textbf{Member, Equity, Diversity, and Inclusion (EDI) Committee} \\
Worked with the EDI Committee to foster a more inclusive environment within the College of Arts and Sciences.\\
\years{2021--2023} \textbf{Member, Implementation Council} \\
...
\years{2018--20} CSC 2463 -- Programming Digital Media, Instructor, Louisiana State University, Baton Rouge, LA.
...
\years{2019--20} Coding for the Web, Liberty Magnet High School, Baton Rouge, LA. \\
